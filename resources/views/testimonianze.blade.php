        ...
        <div class="container">
            <div class="page-head mb-4">
                ...
                <div class="d-lg-none mt-2">
                    <a href="#form-testimonianza" class="area-link">Lascia la tua testimonianza</a>
                </div>
            </div>
                ...
                <div class="col-lg-5">
                    <aside class="about-sidebar-sticky">
                        ...
                        <div id="form-testimonianza" class="card shadow-soft p-4 card-chi testimonial-form-card">
                            <h2 class="h4 mb-3 section-subtitle">Invia la tua testimonianza</h2>

                            <p class="mb-3">
                                Se desideri condividere la tua esperienza, puoi inviare una testimonianza
                                che verrà revisionata prima della pubblicazione.
                            </p>
                            ...
                            <form method="POST" action="{{ route('testimonials.store') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="testimonial-name-label" type="text" name="name_label"
                                        ...
                                        autocomplete="name">
                                    <div class="small text-muted mt-1">Usa nome e iniziale del cognome con punto.</div>
                                ...
                                <div class="mb-3">
                                    <label class="form-label" for="testimonial-message">La tua testimonianza</label>
